...
# Veriyi yükle
data_url = r"C:\Users\hasan\OneDrive\Masaüstü\opencv-exercise\MakineOgrenmesiOrta\ckVerisiTahmin\ltsmDenemeler\sacma.xlsx"
...
train = dataFrame.iloc[:1583]
test = dataFrame.iloc[1583:]
...
n_steps = 30  # Tahmin yapmak istediğiniz gün sayısı
...
future_df.to_excel(r"C:\Users\hasan\OneDrive\Masaüstü\opencv-exercise\MakineOgrenmesiOrta\ckVerisiTahmin\gelecek_tahminleri(gercek).xlsx", index=False)
